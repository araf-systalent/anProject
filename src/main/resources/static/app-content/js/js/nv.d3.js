...
nv.models.boxPlot = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0},
        ...
        getQ1 = function (d) { return parseInt(d.values.Q1) },
        getQ2 = function(d) { return parseInt(d.values.Q2) },
        getQ3 = function(d) { return parseInt(d.values.Q3) },
        getWl = function(d) { return parseInt(d.values.whisker_low) },
        getWh = function(d) { return parseInt(d.values.whisker_high) },
        getColor = function(d) { return d.color },
        getOlItems  = function(d) { return d.values.outliers },
        getOlValue = function(d, i, j) { return d },
        getOlLabel = function(d, i, j) { return d },
        getOlColor = function (d, i, j) { return undefined },
        getActualItems = function (d) {return JSON.parse("[" + ((d.values.Actual == 0 | d.values.Actual == undefined) ? '' : d.values.Actual) + "]"); },
        getActualColor = function (d, i, j) { return "#e07d40" },
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
                ...
                data.forEach(function (d, i) {
                    ...
                    if (olItems) {
                        olItems.forEach(function (e, i) {
                            values.push(parseInt(getOlValue(e, i, undefined)));
                        });
                    }
                    var actItems = getActualItems(d);
                    if (actItems) {
                        actItems.forEach(function (e, i) {
                            values.push(parseInt(getOlValue(e, i, undefined)));
                        });
                    }
                    
                    if (wl) { values.push(parseInt(wl)) }
                    if (q1) { values.push(parseInt(q1)) }
                    if (q3) { values.push(parseInt(q3)) }
                    if (wh) { values.push(parseInt(wh)) }
                });
                yMin = d3.min(values);
                yMax = d3.max(values);
                //var actMin = (yMin > 0) ? 0 : yMin;
                yData = [yMin, yMax];
            }
            ...
            var box_width = function () { return (maxBoxWidth === null ? xScale.rangeBand() * 0.9 : Math.min(maxBoxWidth, xScale.rangeBand() * 0.9)); };
            ...
            boxEnter.append('rect')
                ...
                .on('mouseover', function(d,i) {
                    d3.select(this).classed('hover', true);
                    dispatch.elementMouseover({
                        key:moment(d.values.Date).format("MM-DD-YYYY"),
                        value: moment(d.values.Date).format("MM-DD-YYYY"),
                        series: [
                            { key: 'High', value: getQ3(d) + " patients", color: getColor(d) || color(d,i) },
                            { key: 'Medium', value: getQ2(d) + " patients", color: getColor(d) || color(d, i) },
                            { key: 'Low', value: getQ1(d) + " patients", color: getColor(d) || color(d, i) }
                        ],
                        data: d,
                        index: i,
                        e: d3.event
            ...
            boxplots.select('rect.nv-boxplot-box')
              .watchTransition(renderWatch, 'nv-boxplot: boxes')
                ...
                .attr('x', box_left )
                .attr('height', function(d,i) { return Math.abs(yScale(getQ3(d)) - yScale(getQ1(d))) || 0 })
            ...
            boxplots.select('line.nv-boxplot-median')
              .watchTransition(renderWatch, 'nv-boxplot: boxplots line')
                ...
                .attr('x2', function (d, i) { var calX2 = (d.values.whisker_high === 0 ? 0 : box_right()); return calX2; })
            ...
            // outliers
            var actualData = boxplots.selectAll('.nv-boxplot-outlier-act').data(function (d) {
                return getActualItems(d) || [];
            });
            actualData.enter().append('circle')
                .style('fill', function (d, i, j) { return getOlColor(d, i, j) || color(d, j) })
                .style('stroke', function (d, i, j) { return getOlColor(d, i, j) || color(d, j) })
                .style('z-index', 9000)
                .on('mouseover', function (d, i, j) {
                    d3.select(this).classed('hover', true);
                    dispatch.elementMouseover({
                        series: { key: getOlLabel(d, i, j), color: getActualColor(d, i, j) || color(d, j) },
                        e: d3.event
                    });
                })
                .on('mouseout', function (d, i, j) {
            ...
            actualData.attr('class', 'nv-boxplot-outlier-act');
            actualData
              .watchTransition(renderWatch, 'nv-boxplot: nv-boxplot-outlier-act')
                .attr('cx', xScale.rangeBand() * 0.45)
                .attr('cy', function (d, i, j) { return yScale(getOlValue(d, i, j)); })
                .attr('r', '6');
            actualData.exit().remove();
    ...
    chart._options = Object.create({}, {
        ...
        actual: { get: function () { return getActualItems; }, set: function (_) { getActualItems = _; } },
